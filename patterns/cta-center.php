...
<h2 class="wp-block-heading has-text-align-center" style="font-size:3rem;font-style:normal;font-weight:700"><?php echo esc_html_x( 'Ready to Get Started?', 'waver' ); ?></h2>

<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|secondary-400"}}}},"textColor":"secondary-400"} -->
<p class="has-text-align-center has-secondary-400-color has-text-color has-link-color"><?php echo esc_html_x( 'Act Fast, Live Large: Embrace Exclusive Deals Before They Vanish!', 'waver' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-button"><a class="wp-block-button__link has-text-color has-background has-link-color has-border-color has-primary-600-border-color wp-element-button" style="border-width:1px;border-radius:6px;color:#4f46e5;background-color:#ffffff"><?php echo esc_html_x( 'Learn more →', 'waver' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->