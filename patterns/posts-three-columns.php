...
<p class="has-primary-600-color has-text-color has-link-color">Our Blog</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->

<!-- wp:heading {"textAlign":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"700","fontSize":"3rem"}}} -->
<h2 class="wp-block-heading has-text-align-center" style="font-size:3rem;font-style:normal;font-weight:700">Latest articles from the <span style="color: var(--wp--preset--color--primary-600)">blog</span>.</h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
