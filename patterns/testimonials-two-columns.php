...
<p class="has-secondary-400-color has-text-color has-small-font-size" style="margin-top:0"><?php echo esc_html_e( 'Software Developer', 'waver' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"0"}}},"textColor":"secondary-400","fontSize":"small"} -->
<p class="has-secondary-400-color has-text-color has-small-font-size" style="margin-top:0"><?php echo esc_html_e( 'Designer', 'waver' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
