...
<h2 class="wp-block-heading has-text-align-center has-text-color has-link-color" style="color:#ffffff;font-size:3rem;font-style:normal;font-weight:700"><?php echo esc_html_e( 'Let\'s not stress for WordPress designs.', 'waver' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","style":{"typography":{"lineHeight":"1.2"},"elements":{"link":{"color":{"text":"#ffffff"}}},"color":{"text":"#ffffff"}}} -->
<p class="has-text-align-center has-text-color has-link-color" style="color:#ffffff;line-height:1.2"><?php echo esc_html_e( 'Why spend hours designing from scratch when you can use Waver to build your dream website in minutes? Time-saving and hassle-free!', 'waver' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link has-primary-600-color has-text-color has-background has-link-color wp-element-button" style="background-color:#f9f9f9"><?php echo esc_html_e( 'Learn more →', 'waver' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->