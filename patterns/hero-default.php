...
<h1 class="wp-block-heading alignwide has-text-align-center" style="font-size:4.6rem;font-style:normal;font-weight:600;line-height:1.1">Let's not stress for <span style="color: var(--wp--preset--color--primary-600)">WordPress</span> designs.</h1>
<!-- /wp:heading -->
...
<p class="has-text-align-center has-secondary-500-color has-text-color has-link-color" style="line-height:1.4">Why spend hours designing from scratch when you can use Waver to build your dream website in minutes? Time-saving and hassle-free!</p>
<!-- /wp:paragraph -->
